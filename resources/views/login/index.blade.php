                ...
                <form action="{{url('/login')}}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username"
                               {{$username == null ?: "value = ${username}"}} required>
                    </div>
                    <div class="form-group">
                        <label class="mb-2">Mật khẩu</label>
                        <input type="password" class="form-control" name="password"
                               {{$password == null ?: "value = ${password}"}} required>
                    ...
                    <button type="submit" class="btn submit mb-4" style="background-color: #28a745">Đăng nhập</button>
                    <a href="{{url('/login/google')}}" id="btn-login-google" class="btn" role="button">
                        Đăng nhập với google <i class="fa fa-google-plus" aria-hidden="true"></i>
                    </a>
                </form>
            </div>
        </div>
